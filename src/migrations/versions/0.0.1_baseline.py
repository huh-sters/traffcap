...
def upgrade() -> None:
    ...
    sa.Column('headers', sqlmodel.sql.sqltypes.AutoString(length=1024), nullable=False),
    sa.Column('query_params', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
